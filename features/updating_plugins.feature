Feature: Updating Plugins
  ...
  Scenario: Before update
    Given I have "tinytacoteam/zazu-fallback" installed before mdn support
    And the app is launched
    When I toggle it open
    And I type in "mdn bind"
  ...
  Scenario: Update plugin
    ...
    Then the search window is visible
    And I have 1 result
    And the active result contains "Search Mozilla Developer Network for bind"
